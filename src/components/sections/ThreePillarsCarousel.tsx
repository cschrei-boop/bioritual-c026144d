        ...
        delay: 0.2
          ...
          loop: true
            ...
            <CarouselContent className="-ml-6">
              {pillars.map(pillar => <CarouselItem key={pillar.title} className="pl-6 md:basis-1/2 lg:basis-1/3">
                  <div className="group">
                    {/* Image */}
                    <div className="aspect-[4/3] mb-6 overflow-hidden">
                      <img src={pillar.image} alt={pillar.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500 border-none rounded-none border-0" />
                    </div>
                    ...
                    <Link to={pillar.href} className="text-sm border-b border-foreground pb-0.5 hover:opacity-60 transition-opacity">
                      Learn More
                    </Link>
                  </div>
                </CarouselItem>)}
