  ...
  return (
    <footer className="relative py-16 px-6 border-t border-border/30">
      <div className="max-w-5xl mx-auto">
        <div className="backdrop-blur-xl bg-background/60 border border-border/50 rounded-3xl p-8 md:p-12">
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <span className="text-sm tracking-[0.3em] text-foreground uppercase font-medium">
                BIORITUAL
              </span>
