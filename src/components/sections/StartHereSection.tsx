...
export const defaultStartHereCards: CardData[] = [
  {
    ...
    body: "Explore peptides + supplements in plain language.",
    bestIf: "I want to understand this before acting.",
    ctaLabel: "Learn with the AI Concierge",
    href: "/ai-concierge",
    icon: Sparkles,
    node: "Learn",
  },
  {
    ...
    body: "3-month systems for a specific priority (metabolism, energy, recovery, cognition, longevity).",
  ...
  },
  {
    ...
    body: "Founder-led, weekly sessions to build BioRitual (your baseline system) before optimization.",
