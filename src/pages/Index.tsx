  ...
  return (
    <main className="relative min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <FinalCTA
        ...
        description=""
        body="Start wherever you are. Join the Jesse™ waitlist if you're not sure. Move into a protocol when you're ready. Bring in the founders if you want a human in the room. There's no wrong entry point."
        buttons={[
