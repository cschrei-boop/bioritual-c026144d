  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Tired of conflicting advice about GLP-1 weight loss drugs? We break down the most common GLP-1 myths, side effects, and safety concerns—without hype or shame." 
        />
      ...
      <main>
        ...
        <section className="relative min-h-[70vh] flex items-center">
          <div className="absolute inset-0">
            <img 
              src={heroImage} 
              alt="Understanding GLP-1 medications" 
        ...
        <section className="py-20 md:py-32 px-6 md:px-12 bg-foreground text-background">
          <div className="max-w-3xl mx-auto text-center">
            <Section>
              ...
              <Button 
                size="lg" 
                className="bg-background text-foreground hover:bg-background/90 rounded-none px-10 py-6 text-sm tracking-wider"
                asChild
              >
