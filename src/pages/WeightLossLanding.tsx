  ...
  return (
    <BlogPageTemplate
      ...
      hero={{
        type: "image",
        image: protocolHero,
        imageAlt: "Structured wellness approach to weight loss",
        tagline: "Education · Protocols · Decision Support",
        title: "Simple, Structured Wellness for Weight Loss",
        subtitle: "A science-backed, structured approach to weight loss. Learn how bio signals, habits, and protocols fit together for sustainable results.",
        children: (
